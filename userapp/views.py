...
from userapp.forms import applyjobs
...
def home(request):
    ...
    return render(request, "home.html", {"sub": sub, "saved": saved, "error_message": error_message,"blogposts":blogposts,"top_post":top_post,"newblog":newblog})
